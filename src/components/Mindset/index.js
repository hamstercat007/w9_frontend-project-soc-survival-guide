...
<h1>Mindset migs!</h1>
<div className="row-1">
<img src="https://images.chinahighlights.com/allpicture/2018/04/31efcb6e4c9e45e7b9d8f6e3_cut_800x500_61.jpg" alt="#" />
<p >"IT'S NOT ABOUT NEVER BEING OFF BALANCE, IT'S ABOUT THE SPEED AT WHICH YOU RECOVER IT"</p>
</div>
<div className="row-two">

<div class="card">
  
  <img src="https://miro.medium.com/max/1400/0*aSS1iLR9suzBPLc2.png" alt="Avatar" style={{width: "50%" }}/>
  <div class="container">
...
<div class="card">
  <img src="https://img.freepik.com/free-vector/sack-money-big-pile-cash-money-icon-illustration-money-bag-flat-icon_385450-362.jpg" alt="Avatar" style={{width: "40%" }}/>
  <div class="container">
